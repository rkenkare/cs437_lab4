...
data_path = "/Users/ronankenkare/Documents/Projects/Project_027/Labs/Lab4/vehicle_data/vehicle4.csv"

#Path to your certificates, modify this
certificate_formatter = "certificates/0f16dc1f239f5fd4a2bd01d6d5685e7117f412c55494e798d2829c046bdfbe02-certificate.pem.crt"
key_formatter = "certificates/0f16dc1f239f5fd4a2bd01d6d5685e7117f412c55494e798d2829c046bdfbe02-private.pem.key"
...
class MQTTClient:
    def __init__(self, device_id, cert, key):
        ...
        self.client.configureEndpoint("a1mquhwarr6v9-ats.iot.us-east-2.amazonaws.com", 8883)
    ...
    def customOnMessage(self,message):
        ...
        print("client {} received payload {} from topic {}".format(self.device_id, message.payload.decode('utf-8'), message.topic))
